    ...
    */
    ...
    public:
        ...
        */
         ...
         * orientation quaternion.
         *
         * @param a The real component of the rigid body's orientation
         * quaternion.
         *
         * @note The given orientation does not need to be normalised,
         * and can be zero. This function automatically constructs a
         ...
         * (1,0,0,0).
         */
        void SetOrientation(real i, real j, real k, real a);
        ...
        */
        void GetLastFrameLinearAcceleration(Vector3* linearAcceleration) const;
        ...
        */
        Vector3 GetLastFrameLinearAcceleration() const;
    ...
    private:
        ...
        */
        ...
        /**
        * Creates an inertia tensor transform.
        */
        static void TransformInertiaTensor(Matrix& inverseInertiaTensorWorld, const Matrix& inverseInertiaTensorLocal,
    ...
    protected:
        ...
        * properties. Two identical rigid bodies will have the same
        ...
        * weighted mean that can be used to put a body to slerp.
        */
        real motion;
